...
registerBlockType( metadata.name, {
	...
	edit: ( { attributes, setAttributes } ) => {
		const { productList, searchQuery, currentPage, itemsPerPage } =
			attributes;
				...
				{ isModalOpen && (
					...
					>
						...
						<RichText
							...
							onChange={ ( value ) =>
								handleInputChange( 'specDesc', value )
							}
						...
						<TextControl
							...
							onChange={ ( value ) =>
								handleInputChange( 'linkTokopedia', value )
							}
							className="mb-4"
						/>
						<TextControl
							...
							onChange={ ( value ) =>
								handleInputChange( 'linkShopee', value )
							}
							className="mb-4"
						/>
						<TextControl
							...
							onChange={ ( value ) =>
								handleInputChange( 'catalogLink', value )
							}
							className="mb-4"
						/>
						<Button
