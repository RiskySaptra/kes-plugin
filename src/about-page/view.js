				...
				<div className="bg-[#C51714] flex pb-10 pt-2 md:pl-10 px-5">
					<div className="text-white mx-auto max-w-[1280px] flex flex-col items-center w-full">
						...
						<ul class="list-disc ml-5 text-base md:!text-xl">
							<li>
								Konsisten dalam menyediakan produk berkualitas
								sesuai dengan kebutuhan pelanggan.
							</li>
							<li>
								Komitmen dalam memberikan pelayanan terbaik
								melalui jaminan harga yang kompetitif dan
								kecepatan respon kepada para pelanggan.
							</li>
							<li>
								Berbudaya kerja profesional dengan mengedepankan
								sinergi dan komunikasi dalam tim.
							</li>
							<li>
								Berdaya saing melalui adaptasi perkembangan
								teknologi.
							</li>
						</ul>
					</div>
