...
const WhyUs = () => {
	...
	const items = [
		...
		},
		{
			...
			text: (
				<>
					Kami siap mengantarkan pesanan Anda dengan jaminan
					pengiriman maksimal H+2 hari kerja setelah transaksi, ke
					seluruh area Jabodetabek.
					<br />
					<span
			...
			{ showTerms && (
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
					<div className="bg-white p-8 rounded-lg shadow-lg w-4/5 max-w-[600px]">
						...
						<p className="text-sm">
							Pengiriman gratis berlaku untuk area Jakarta dan
							sekitarnya, dan terbatas pada pembelian minimum
							tertentu. Silakan hubungi layanan pelanggan kami
